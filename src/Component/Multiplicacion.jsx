      ...
      <div className="tema-principal">
        <div>
          <div className="indice">
            ...
            <ul>
              <div id="tabla-contenido">
                <li>
                  {" "}
                  <a href="#Qué_es_la_multiplicacion">¿Qué es la resta?</a>
                </li>
                <a href="#Qué_es_la_multiplicacion"></a>
                <li>
                  <a href="#Qué_es_la_multiplicacion"> </a>
                  <a href="#Partes_de_la_multiplicacion">Partes de la resta</a>
                </li>
                <a href="#Partes_de_la_multiplicacion"></a>
                <li>
                  <a href="#Partes_de_la_multiplicacion"> </a>
                  <a href="#Propiedades_de_la_multiplicacion">Propiedades de la suma</a>
                </li>
                <a href="#Propiedades_de_la_multiplicacion"></a>
                <li>
                  <a href="#Propiedades_de_la_multiplicacion"></a>
                  <a href="#Resolver_una_multiplicacion">Resolver una suma</a>
                </li>
          ...
          <div>
            ...
            <ul>
              <li>
                <strong>Factores:</strong> que son los números que se
                ...
                suma el multiplicando.
              </li>
              <li>
                <strong>Producto:</strong> es el resultado de la multiplicación.
              </li>
              <li>
                <strong>Signo:</strong> hay diferentes formas de representarlo,
          ...
          <div>
            ...
            <ul>
              <li>
                <strong>Propiedad Conmutativa:</strong> esta propiedad refiere,
              ...
              <li>
                <strong>Propiedad Asociativa:</strong> si se deben multiplicar
                ...
                * 3) * 5 = 6 * 5 = 30, se puede realizar de la manera: 2 * (3 *
                5) = 2 * 15 = 30. El resultado es el mismo.
              </li>
              <li>
                <strong>Propiedad del Elemento Neutro:</strong> es también
              ...
              <li>
                ...
                resta, pero el proceso es el mismo.
              </li>
            </ul>
            <br />
            ...
            <div>
              ...
              <div>
                <ul>
                  ...
                  <h3>PASO 2</h3>
                  <p>multiplicar 2 con el dígito de las decenas (4 × 3 = 8)</p>
                  <h3>PASO 3</h3>
                  <p>
                    se multiplica 2 con el dígito en el lugar de las centenas.
                    (2 × 2 = 2)
                  </p>
                  <h3>PASO 4</h3>
                  <p>
              ...
              <p>
                ...
                <div>
                  <ul>
                    <h3>PASO 1</h3>
                    <p>se multiplica 1243 x 2, según el proceso anterior.</p>
                    <h3>PASO 2</h3>
                    <p>
                    ...
                    <h3>PASO 3</h3>
                    <p>se suman los productos obtenidos</p>
